...
.NOTES
    This is the quickest way to see what you can do with the platform.
#>
...
Write-Host "    up-tools.ps1           Core + tools (recommended)" -ForegroundColor White
Write-Host ""
...
Write-Host "  down.ps1                 Stop platform" -ForegroundColor White
...
Write-Host "  2. .\up-tools.ps1        Start the platform" -ForegroundColor Cyan
...
Write-Host "─────────────────────────────────────────────────────────────────" -ForegroundColor Gray
Write-Host "  • Run scripts from repo root: .\scripts\windows\up-tools.ps1" -ForegroundColor Gray
